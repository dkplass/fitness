...
export const WORKOUTS: IWorkouts = {
  individual: [
    "biceps",
    "triceps",
    "chest",
...
/**
 * write a function
 * 1. flattens EXERCISES with all the variants
 * 2. if at home, then have to specify equipment
 * 3. add instructions for substitutions (at home substitutions) for weights etc
 * 4. variant is just going to be gym (forget about home stuff as long as one of the variants is
 ...
 * 6. pick a random exercise
 * 7. for non-members, exclude all the at home specific exercises
 */
// const bw_exercises = {};
...
export const EXERCISES: IExercises = {
  barbell_bench_press: {
    type: "compound",
    meta: {
      environment: "gym",
